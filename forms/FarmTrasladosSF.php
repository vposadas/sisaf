...
<div class="container-fluid" style="margin-top: 50px">
    <div id="FrmTrasladosSF" class="card">
        <div class="modal-header text-center white-text green-grad">
            <h3 class="modal-title w-100 font-weight-bold">TRASLADO SATELITE - FARMACIA</h3>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"
                    onclick="$('#FrmTrasladosSF').fadeOut();">
            ...
            <div class="row">
                ...
                <div class="input-group input-group-sm mb-sm-3 col-sm-3">
                    ...
                    <select class="form-control" id="TipEntregaTras">
                        ...
                        <option value="3">Bodega Satélite Medicamentos</option>
                        <option value="4">Bodega Satélite MMQM y Afines</option>
                    </select>
