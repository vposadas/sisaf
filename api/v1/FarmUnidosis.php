...
//Procedimiento para modificar
        try {
            ...
            $stmt = $Db->Sentencia("UPDATE Farm.EncabezadoUnidosis SET EncCharEstadoUnidosis = 'S' WHERE FarmNumEncUnidosis = ?");
...
//Procedimiento para Mostrar
        ...
        if(isset($_REQUEST['Encabezado'])){
            ...
            $data = $Db->GetData("select * from Farm.vw_mostraEncabezado where EncNumIdServEncam = $EncNumIdServEncam and EncCharEstadoUnidosis is null", $_SESSION['dbUser'], $_SESSION['dbPass']);
