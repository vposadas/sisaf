...
class InfoConsolidadoFarmTabla{
    protected $infoCita;

    function FnInfoConsolidadoFarm($data){
        $this->infoCita = $data;
    }

    function RenderInfoConsolidadoFarm(){
 ...
 collapse;table-layout:fixed;width:1000pt'>
            ...
            <col class=x21 width=119 style='mso-width-source:userset;width:300pt'>
            <col class=x21 width=145 span=3 style='mso-width-source:userset;width:25pt'>
            <col class=x21 width=115 style='mso-width-source:userset;width:80pt'>
            <col class=x21 width=98 style='mso-width-source:userset;width:80pt'>
            <col class=x21 width=75 style='mso-width-source:userset;width:80pt'>
            <col class=x21 width=67 style='mso-width-source:userset;width:30pt'>
            <col class=x21 width=88 style='mso-width-source:userset;width:20pt'>
            ...
            <tr height=26 style='mso-height-source:userset;height:19.5pt' id='r4'>
                ...
                <td class=x52>No.<span style='mso-spacerun:yes'>&nbsp;&nbsp; </span><?php echo $matriz2['FarmNumIdConsoli'];  ?></td>
                <td class=x21></td>
            </tr>
            ...
            <tr height=52 style='mso-height-source:userset;height:25pt' id='r14'>
                ...
                <td class=x50>DESCRIPCION DEL PRODUCTO</td>
                <td colspan=3 class=x46 style='border-bottom:2px solid windowtext;'>SUB TOTAL</td>
                <td class=x48 style='overflow:hidden;'>NO. LOTE</td>
                <td class=x47 style='overflow:hidden;'>FECHA VENCIMIENTO</td>
                <td class=x48 style='overflow:hidden;'>DEVOLUCIONES</td>
                <td colspan=3 class=x48 style='border-right:2px solid windowtext;border-bottom:2px solid windowtext;'>NO. LOTE</td>
                <td class=x47 style='overflow:hidden;'>FECHA VENCIMIENTO</td>
                <td class=x48 style='overflow:hidden;'>TOTAL ENTREGADO</td>
            ...
            <?php
            $cont=0;
            foreach ($matriz2['ArrayDescripcion']  as $row) {
                $cont++;
...
l
                <tr height=39 style='mso-height-source:userset;height:20pt' id='r15'>
                    ...
                    <td class=x43 align="justify"><?php echo $row['AlmacNumCodInsumo']." ".$row['StrNombreInsumo'] ?></td>
                    <td colspan=3 class=x41 style='border-bottom:1px solid windowtext;' align="center"><?php echo $row['FarmNumSubtotal']  ?></td>
                    <td class=x43 align="center"><?php echo $row['FarmStrNolote'] ?></td>
                    <td class=x43 align="center"><?php echo $row['FarmDateVencimiento'] ?></td>
                    <td class=x42 align="center"><?php if($row['FarmNumDevoluciones']==0){echo' ';}else { echo $row['FarmNumDevoluciones'] ;} ?></td>
                    <td colspan=3 class=x43 style='border-right:2px solid windowtext;border-bottom:1px solid windowtext;' align="center"><?php  if($row['FarmNumDevoluciones']==0){echo' ';}else { echo $row['FarmStrNoLoteDev'] ;}?></td>
                    <td class=x43 align="center"><?php if($row['FarmNumDevoluciones']==0){echo' ';}else { echo $row['FarmDateVenciDev'] ;}  ?></td>
                    <td class=x43 align="center"><?php  echo $row['FarmNumTotalEntregado'] ; ?></td>
                    <td class=x21></td>
                </tr>
            ...
            <tr height=39 style='mso-height-source:userset;height:20pt' id='r16'>
                <td height=39 class=x21 style='height:20pt;'></td>
                <td class=x38 align="center">---------------Última Línea---------------</td>
