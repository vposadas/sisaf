...
//Procedimiento para agregar
        try {
            ...
            $stmt = $Db->Sentencia("Almac.Sp_AddVencimiento ?, ?, ?, ?, ?");

            $stmt->bindParam(1, $_REQUEST{'AlmacDateVenci'});
            $stmt->bindParam(2, $_REQUEST{'AlmacStrLote'});
            $stmt->bindParam(3, $_REQUEST{'AlmacNumCantidad'});
            $stmt->bindParam(4, $_REQUEST{'AlmacNumIdKardex'});
            $stmt->bindParam(5, $_REQUEST{'AlmacNumIdForm1H'});
...
//Procedimiento para Mostrar
        ...
        $data = $Db->GetData("SELECT * FROM Almac.Vencimiento", $_SESSION['dbUser'], $_SESSION['dbPass']);
