...
require_once '../functions/InfoFarmRequiTabla.php';
...
$data[0]['ArrayDetalle'] = $Db->GetData("SELECT I.AlmacNumCodInsumo, DR.FarmStrDescripcion, DR.FarmNumCantSolicit, DR.FarmNumCantDespac, DR.FarmStrNolote, DR.FarmDateVencimiento  FROM Farm.DetalleRequi DR INNER JOIN Almac.Insumos I ON I.AlmacNumCodPresentInsu = DR.AlmacNumCodPresentInsu WHERE FarmNumIdRequi = $FarmNumIdRequi", $_SESSION['dbUser'], $_SESSION['dbPass']);
