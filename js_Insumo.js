...
function EnviarInfoHorario(IntCodInsumo, IntRenglon, StrNomInsumo,StrCaractInsu,StrPresentInsu,StrCantYUnidInsu,IntCodPresentInsu) {
    let HorariosObjeto = {
